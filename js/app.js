import { DataHandler } from './data-handler.js?v=2.0.2';
import { renderStandings } from './render-standings.js?v=2.0.2';
import { renderBracket } from './render-bracket.js?v=2.0.2';
