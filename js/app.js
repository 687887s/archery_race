import { DataHandler } from './data-handler.js?v=1.1.5';
import { renderStandings } from './render-standings.js?v=1.1.5';
import { renderBracket } from './render-bracket.js?v=1.1.5';
