import { DataHandler } from './data-handler.js?v=1.6.3';
import { renderStandings } from './render-standings.js?v=1.6.3';
import { renderBracket } from './render-bracket.js?v=1.6.3';
