import { DataHandler } from './data-handler.js?v=2.2.1';
import { renderStandings } from './render-standings.js?v=2.2.1';
import { renderBracket } from './render-bracket.js?v=2.2.1';
