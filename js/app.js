import { DataHandler } from './data-handler.js?v=2.3.0';
import { renderStandings } from './render-standings.js?v=2.3.0';
import { renderBracket } from './render-bracket.js?v=2.3.0';
