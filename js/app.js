import { DataHandler } from './data-handler.js?v=1.9.0';
import { renderStandings } from './render-standings.js?v=1.9.0';
import { renderBracket } from './render-bracket.js?v=1.9.0';
