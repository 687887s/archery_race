import { DataHandler } from './data-handler.js?v=1.8.8';
import { renderStandings } from './render-standings.js?v=1.8.8';
import { renderBracket } from './render-bracket.js?v=1.8.8';
