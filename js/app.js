import { DataHandler } from './data-handler.js?v=2.3.5';
import { renderStandings } from './render-standings.js?v=2.3.5';
import { renderBracket } from './render-bracket.js?v=2.3.5';
